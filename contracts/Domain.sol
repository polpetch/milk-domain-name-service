            ...
            bytes(
                string(
                    abi.encodePacked(
                        '{"name": "',
                        _name,
                        '", "description": "A domain on the .Milk name service", "image": "data:image/svg+xml;base64,',
